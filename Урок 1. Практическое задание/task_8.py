...
user_year = int(input('Введите год, чтобы узнать вискокосный ли он '))
...
print('Год високосный ') if user_year % 4 == 0 and user_year % 100 != 0 or user_year % 400 == 0 else print('Год не високосный ')