...
try:
    # Ветвление
    # Отрицательный ввод не обрабатываю, будем считать, что до н.э.
    YEAR = int(input('Введите год: '))
    # Условие можно записать иначе, но теряется читаемость, хотя на вкус и цвет:
    ...
    # Тернарный оператор
    print('Год високосный' if YEAR % 4 == 0 and YEAR % 100 or YEAR % 400 == 0
