...
try:
    ...
    # решение через обычное ветвление
    if YEAR % 400 == 0 or (YEAR % 4 == 0 and YEAR % 100 != 0):
        print('год высокосный')
    else:
        print('год не высокосный')
    # решение через тернанрый оператор
    print('год высокосный') if YEAR % 400 == 0 or (YEAR % 4 == 0 and YEAR % 100 != 0) else print('год не высокосный')
except ValueError:
