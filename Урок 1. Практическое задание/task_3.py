...
X1 = int(input("Введите первую кординату первой точки: "))
Y1 = int(input("Введите вторую кординату первой точки: "))
X2 = int(input("Введите первую кординату второй точки: "))
Y2 = int(input("Введите вторую кординату второй точки: "))

K = (Y1 - Y2) / (X1 - X2)
B = Y2 - K * X2

print(f'Уравнение прямой для точек с координатами {X1} , {Y1}  и {X2} , {Y2}:')
print(f'y = {K}x + {B}')
