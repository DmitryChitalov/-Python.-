...
"""
X1_VAL = int(input('Введите значение X первой точки '))
Y1_VAL = int(input('Введите значение Y первой точки '))
X2_VAL = int(input('Введите значение X второй точки '))
Y2_VAL = int(input('Введите значение X второй точки '))

k = (Y2_VAL - Y1_VAL) / (X2_VAL - X1_VAL)
b = Y1_VAL - (Y2_VAL - Y1_VAL) * X1_VAL / (X2_VAL - X1_VAL)

print(f'уравнение прямой  проходящей чеерез две точки y = {k}x + {b}')