...
"""
X1 = int(input("Введите значение координаты X1 первой точки: "))
Y1 = int(input("Введите значение координаты Y1 первой точки: "))
X2 = int(input("Введите значение координаты X2 второй точки: "))
Y2 = int(input("Введите значение координаты Y2 второй точки: "))
K = (Y2 -Y1)/(X2 - X1)
B = Y2 - K*X2
