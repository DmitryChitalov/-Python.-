...
На последнем шаге формирования нового массива (где максимальное и минимальное числа поменялись местами) есть нагрузка на 
память. Как я понимаю, загрузка памяти здесь связана с тем, что во-первых, изначальный массив "проходится" два раз при 
поиске минимального и максимального чисел (что само по себе должно быть затратно по памяти, поскольку нахождение мин и 
макс предполагает поэтапное сравнение чисел в массиве), а во-вторых, выполняется перестановка этих чисел в массиве и 
фактически формируется новый список. При этом память нагружается меньше, чем при формировании изначального массива из 
заданного интервала, поскольку мы работаем уже со сформированным массивом, который сильно меньше интервала 0-100000.
