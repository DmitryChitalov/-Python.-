...
while True:
    factor = input('Введите операцию (+, -, *, / или 0 для выхода): ')

    if factor == '0':
        print('Вы вышли из Калькулятора')
        break
    if factor in ('+', '-', '*', '/', '0'):
        a = int(input('Укажите первое число для операции: '))
        b = int(input('Укажите второе число для операци: '))
        if factor == '+':
            print(f'Сумма первого и второго числа равна: {a + b}')
        elif factor == '-':
            print(f'Разность первого и второго числа равна: {a - b}')
        elif factor == '*':
            print(f'Произведение двух чисел равно: {a * b}')
        elif factor == '/':
            if a != 0:
                print(f'Деление двух числе равно: {a / b}')
            else:
                print('Нельзя делить на ноль')
    else:
        print('Вы ввели некоректную операцию: ')