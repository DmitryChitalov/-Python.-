...
# n = 100
#cycle(n) - 0.011740400000000005: чем больше n, тем больше итераций цикла
#cal1_recur(n) -  0.030192599999999993: чем больше n, тем больше раз функция вызовет сама себя
